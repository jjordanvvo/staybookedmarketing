    ...
    <section className="section section-deep contact-section" id="contact">
      <div className="contact-center">
        <Reveal className="wrap wrap-contact" amount={0.3}>
          ...
          <RevealItem as="p" className="body contact-body">Ready for a steady flow of qualified customers? Reach out and we'll show you exactly what a lead generation system would look like for your business.</RevealItem>
