    ...
    <footer className="footer">
      ...
      <div className="footer-socials">
        <a
          ...
          href="https://www.linkedin.com/company/staybookedmarketing"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Stay Booked Marketing on LinkedIn"
        >
        ...
        <a
          ...
          href="https://www.instagram.com/staybookedmarketing"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Stay Booked Marketing on Instagram"
        >
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
